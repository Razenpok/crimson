...
import { type RuntimeResources, type SmallFontData, TextureId, getTexture } from '../engine/assets.ts';
import { RGBA } from '../engine/color.ts';
import { Vec2 } from '../engine/geom.ts';
import { drawSmallText } from '../engine/fonts/small.ts';
import { type BonusHudState } from '../game/bonuses/hud.ts';
import { GameMode } from '../game/game-modes.ts';
import { survivalLevelThreshold } from '../game/gameplay.ts';
import { type PlayerState } from '../game/sim/state-types.ts';
import { WEAPON_BY_ID, WeaponId, weaponDisplayName } from '../game/weapons.ts';
