...
export const HUD_TEXT_COLOR = wgl.makeColor(220 / 255, 220 / 255, 220 / 255, 1.0);
export const HUD_HINT_COLOR = wgl.makeColor(170 / 255, 170 / 255, 180 / 255, 1.0);
export const HUD_ACCENT_COLOR = wgl.makeColor(240 / 255, 200 / 255, 80 / 255, 1.0);

export const HUD_BASE_WIDTH = 1024.0;
export const HUD_BASE_HEIGHT = 768.0;

export const HUD_TOP_BAR_ALPHA = 0.7;
export const HUD_ICON_ALPHA = 0.8;
export const HUD_PANEL_ALPHA = 0.9;
export const HUD_HEALTH_BG_ALPHA = 0.5;
export const HUD_AMMO_DIM_ALPHA = 0.3;

export const HUD_TOP_BAR_POS: [number, number] = [0.0, 0.0];
export const HUD_TOP_BAR_SIZE: [number, number] = [512.0, 64.0];
export const HUD_HEART_CENTER: [number, number] = [27.0, 21.0];
export const HUD_HEALTH_BAR_POS: [number, number] = [64.0, 16.0];
export const HUD_HEALTH_BAR_SIZE: [number, number] = [120.0, 9.0];
export const HUD_WEAPON_ICON_POS: [number, number] = [220.0, 2.0];
export const HUD_WEAPON_ICON_SIZE: [number, number] = [64.0, 32.0];
export const HUD_CLOCK_POS: [number, number] = [220.0, 2.0];
export const HUD_CLOCK_SIZE: [number, number] = [32.0, 32.0];
export const HUD_CLOCK_ALPHA = 0.9;
export const HUD_AMMO_BASE_POS: [number, number] = [300.0, 10.0];
export const HUD_AMMO_BAR_SIZE: [number, number] = [6.0, 16.0];
export const HUD_AMMO_BAR_STEP = 6.0;
export const HUD_AMMO_BAR_LIMIT = 30;
export const HUD_AMMO_BAR_CLAMP = 20;
export const HUD_AMMO_TEXT_OFFSET: [number, number] = [8.0, 1.0];
export const HUD_SURV_PANEL_POS: [number, number] = [-68.0, 60.0];
export const HUD_SURV_PANEL_SIZE: [number, number] = [182.0, 53.0];
export const HUD_SURV_XP_LABEL_POS: [number, number] = [4.0, 78.0];
export const HUD_SURV_XP_VALUE_POS: [number, number] = [26.0, 74.0];
export const HUD_SURV_LVL_VALUE_POS: [number, number] = [85.0, 79.0];
export const HUD_SURV_PROGRESS_POS: [number, number] = [26.0, 91.0];
export const HUD_SURV_PROGRESS_WIDTH = 54.0;
export const HUD_BONUS_BASE_Y = 121.0;
export const HUD_BONUS_ICON_SIZE = 32.0;
export const HUD_BONUS_TEXT_OFFSET: [number, number] = [36.0, 6.0];
export const HUD_BONUS_SPACING = 52.0;
export const HUD_BONUS_PANEL_OFFSET_Y = -11.0;
export const HUD_XP_BAR_RGBA = new RGBA(0.1, 0.3, 0.6, 1.0);
export const HUD_QUEST_LEFT_Y_SHIFT = 80.0;
