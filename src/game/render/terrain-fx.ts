...
import { GlTexture } from '../../engine/webgl.ts';
import { GroundRenderer, GroundDecal, GroundCorpseDecal } from '../../engine/terrain-render.ts';
import { effectSrcRect } from '../effects-atlas.ts';
import { TerrainFxBatch } from '../sim/terrain-fx.ts';
