...
import { type QuestLevel, questLevelEqual } from '../../game/quests/level.ts';
import {
  type QuestFinalTime,
  QuestResultsBreakdownAnim,
  tickQuestResultsBreakdownAnim,
} from '../../game/quests/results.ts';
import { WeaponId, WEAPON_BY_ID, weaponDisplayName } from '../../game/weapons.ts';
