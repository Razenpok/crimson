...
import { type Weapon, WeaponId, WEAPON_TABLE, WEAPON_BY_ID, weaponDisplayName } from '../../game/weapons.ts';
import { buildWeaponAvailability, type WeaponAvailabilityStatus } from '../../game/weapon-runtime/availability.ts';
import { allQuests } from '../../game/quests/index.ts';
import { weaponsDbRightDetailXShift } from '../high-scores-layout.ts';
