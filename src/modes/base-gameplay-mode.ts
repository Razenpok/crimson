...
import { type AudioState, audioUpdate, audioStopMusic } from '../engine/audio.ts';
import { type ConsoleState } from '../engine/console.ts';
import { type CrandLike } from '../engine/rand.ts';
import { type SmallFontData, measureSmallTextWidth } from '../engine/fonts/small.ts';
import { drawSmallText } from '../engine/fonts/small.ts';
...
import type { CreatureDeath, CreaturePool } from '../game/creatures/runtime.ts';
import { GameMode } from '../game/game-modes.ts';
import type { GameplayState } from '../game/sim/state-types.ts';
import { LocalInputInterpreter, clearInputEdges } from '../game/local-input.ts';
import { PerkId } from '../game/perks/ids.ts';
import { perkCountGet } from '../game/perks/helpers.ts';
import { perkSelectionOpenChoices } from '../game/perks/selection.ts';
import { creatureFindInRadius } from '../game/perks/runtime/effects-context.ts';
import { RtxRenderMode } from '../game/render/rtx/mode.ts';
import { WorldRenderer } from '../game/render/world/renderer.ts';
import { FixedStepClock } from '../game/sim/clock.ts';
import {
  type PresentationTickOutput,
  applyPresentationOutputs,
  applySimMetadataTickResult,
} from '../game/sim/batch-apply.ts';
import { advanceTickRunnerFrame } from '../game/sim/frame-pump.ts';
import {
  type LanFrameSample,
  type LanSyncCallbacks,
  type TickResult,
} from '../game/sim/hooks.ts';
...
import {
  ...
  PerkPickCommand,
  TickSupply,
} from '../game/sim/input-providers.ts';
import {
  type PostApplyReaction,
  applyPostApplyReaction,
  buildPostApplyReaction,
} from '../game/sim/presentation-reactions.ts';
import type { DeterministicSession, DeterministicSessionTick } from '../game/sim/sessions.ts';
import type { PlayerState } from '../game/sim/state-types.ts';
import { TickBatchResult, TickRunner } from '../game/sim/tick-runner.ts';
import type { WorldEvents } from '../game/sim/world-state.ts';
import type { TerrainSlotTriplet } from '../game/terrain-slots.ts';
...
import { WorldRuntime } from '../game/world/runtime.ts';
import type { SimWorldState } from '../game/world/sim-world-state.ts';
import type { RenderResources } from '../game/world/render-resources.ts';
import type { AudioBridge } from '../game/world/audio-bridge.ts';
import type { TerrainRuntime } from '../game/world/terrain-runtime.ts';
import type { PresentationStepCommands } from '../game/sim/presentation-step.ts';
import type { TerrainFxBatch } from '../game/sim/terrain-fx.ts';
