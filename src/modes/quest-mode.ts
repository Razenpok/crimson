...
import { type AudioState, audioPlayMusic } from '../engine/audio.ts';
import { type CrimsonConfig } from '../engine/config.ts';
import { type ConsoleState } from '../engine/console.ts';
import { type GrimMonoFont, createGrimMonoFont } from '../engine/fonts/grim-mono.ts';
...
import {
  buildQuestSession,
} from '../game/sim/session-builders.ts';
import { advanceExplicitTerrain, advanceUnlockTerrain } from '../game/sim/bootstrap.ts';
import { type QuestLevel, questLevelText, questLevelFromGlobalIndex } from '../game/quests/level.ts';
import {
  type QuestDefinition,
  type SpawnEntry,
  type QuestContext,
} from '../game/quests/types.ts';
import { questByLevel } from '../game/quests/index.ts';
import { buildQuestSpawnTable } from '../game/quests/runtime.ts';
import { trackedQuestGamesCounterIndex } from '../game/quests/status.ts';
import { perkSelectionPreparedChoices } from '../game/perks/selection.ts';
import { WeaponId, WEAPON_BY_ID } from '../game/weapons.ts';
import { weaponAssignPlayer, mostUsedWeaponIdForPlayer } from '../game/weapon-runtime/index.ts';
import { RngCallerStatic } from '../game/rng-caller-static.ts';
...
import type { TickResult } from '../game/sim/hooks.ts';
