...
import { survivalCheckLevelUp } from '../game/gameplay.ts';
import {
...
import { buildSurvivalSession } from '../game/sim/session-builders.ts';
...
import { PERK_MENU_TRANSITION_MS } from '../ui/perk-menu.ts';
